...
public class NormalPokemon extends Pokemon {
    ...
    public NormalPokemon(String name, double health, int attack, int defense, Move move1, Move move2, Move move3, Move move4) {
        super(name, Type.NORMAL, health, attack, defense, move1, move2, move3, move4);
    }

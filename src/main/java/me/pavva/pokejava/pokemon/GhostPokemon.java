...
public class GhostPokemon extends Pokemon {
    ...
    public GhostPokemon(String name, double health, int attack, int defense, Move move1, Move move2, Move move3, Move move4) {
        super(name, Type.GHOST, health, attack, defense, move1, move2, move3, move4);
    }
